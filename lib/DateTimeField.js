...
var DateTimeField = (function (_Component) {
  ...
  function DateTimeField() {
    ...
    this.addMinute = function () {
      var addMinutes = 1;
      if (_this.props.inputProps && _this.props.inputProps.stepping) {
        addMinutes = _this.props.inputProps.stepping;
      }
      return _this.setState({
        selectedDate: _this.state.selectedDate.clone().add(addMinutes, "minutes")
      }, function () {
        this.props.onChange(this.state.selectedDate.format(this.props.format));
        return this.setState({
    ...
    this.subtractMinute = function () {
      var minusMinutes = 1;
      if (_this.props.inputProps && _this.props.inputProps.stepping) {
        minusMinutes = _this.props.inputProps.stepping;
      }
      return _this.setState({
        selectedDate: _this.state.selectedDate.clone().subtract(minusMinutes, "minutes")
      }, function () {
    ...
    this.onClick = function () {
      ...
      if (_this.state.showPicker) {
        ...
        return _this.setState({
          // widgetStyle: styles,
          widgetClasses: { classes: classes }
        });
      }
    };

    this.closePicker = function () {
      _this.refs.overlay.hide();
    };
  ...
  _createClass(DateTimeField, [{
    ...
    value: function render() {
      return _react2["default"].createElement(
        ...
        _react2["default"].createElement(
          "span",
          { className: "input-group-btn", ref: "dtpbutton" },
          _react2["default"].createElement(
            _reactBootstrap.OverlayTrigger,
            { trigger: "click", rootClose: true, placement: "left", ref: "overlay", overlay: _react2["default"].createElement(
    ...
    value: {
      ...
      timeMode: _ConstantsJs2["default"].MODE_24H,
    ...
    value: {
      ...
      timeMode: _react.PropTypes.oneOf([_ConstantsJs2["default"].MODE_24H, _ConstantsJs2["default"].AMPM]),
